...
const Announcements = () => {
    ...
    const getAudienceBadgeStyle = (aud) => {
        switch (aud) {
            ...
            case 'MY_TEAM':
                return { bg: 'rgba(16, 185, 129, 0.1)', color: '#10B981', label: 'My Team' };
            default:
    ...
    return (
        <div className="page ext-announcements-3">
            {toast && (
            ...
            <div className="page-header ext-announcements-4">
                <div>
                    <h1 className="page-title">Announcements</h1>
                    <p className="page-subtitle">Broadcasting messages, announcements, and updates</p>
                </div>
                {isAdmin && (
                    <button
            ...
            {/* Filter / Search Bar */}
            <div className="content-card ext-announcements-5">
                <div className="ext-announcements-6">
                    ...
                    <input type="text" placeholder="Search announcements by title..." className="search-input ext-announcements-7" value={searchQuery} onChange={(e) => { setSearchQuery(e.target.value); setPage(1); }} />
                </div>
            </div>
            ...
            {loading ? (
                ...
                <div className="empty-state ext-announcements-8">
                    <p className="ext-announcements-9">No announcements found</p>
                    <p className="ext-announcements-10">Check back later for updates</p>
                </div>
            ) : (
                <div className="ext-announcements-11">
                    {announcements.map((ann) => {
                        ...
                        return (
                            <div key={ann.id} className="content-card ext-announcements-12">
                                <div className="ext-announcements-13">
                                    <div className="ext-announcements-14">
                                        {ann.sender?.profile_picture ? (
                                            <img src={ann.sender.profile_picture} alt="Avatar" className="ext-announcements-15"/>
                                        ) : (
                                            <div
                                                style={{
                                        ...
                                        <div>
                                            <div className="ext-announcements-16">
                                                ...
                                                <span className="ext-announcements-18">
                                                    {ann.sender?.role === 'SUPER_ADMIN' ? 'Super Admin' : 'Admin'}
                                                </span>
                                            </div>
                                            <div className="ext-announcements-19">
                                    ...
                                    <div className="ext-announcements-16">
                                        ...
                                        {isOwn && (
                                            <div className="ext-announcements-20">
                                                <button
                                ...
                                <h2 className="ext-announcements-23">
                                    {ann.title}
                                </h2>
                                <p className="ext-announcements-24">
                                    {ann.message}
                                </p>
                            </div>
                        );
                    ...
                    {/* Pagination */}
                    {totalPages > 1 && (
                        <div className="ext-announcements-25">
                            <button
                                className="btn-primary"
                            ...
                            <span className="ext-announcements-26">
            ...
            {showCreateModal && (
                <div className="ext-announcements-27" onClick={() => setShowCreateModal(false)} >
                    <div
                    ...
                    >
                        <div className="ext-announcements-29">
                            <button
                            ...
                            <h2 className="ext-announcements-31">Post Announcement</h2>
                        </div>
                        <form onSubmit={handleCreateSubmit} className="ext-announcements-32">
                            {formError && (
                            ...
                            <div className="form-group">
                                ...
                                <textarea className="form-input form-textarea ext-announcements-34" placeholder="Enter the detailed message..." value={form.message} onChange={(e) => setForm({ ...form, message: e.target.value })} required />
                            </div>

                            <div className="form-group">
                                <label className="form-label">Audience</label>
                                <div className="ext-announcements-35">
                                    My Team (Your team members only)
                                </div>
                            </div>

                            <div className="ext-announcements-36">
                                <button type="button" className="btn-danger ext-announcements-37" onClick={() => setShowCreateModal(false)}>
                                    Cancel
                                </button>
                                <button type="submit" className="btn-primary ext-announcements-38">
                                    Publish
                                </button>
                            </div>
                        </form>
            ...
            {showEditModal && (
                <div className="ext-announcements-27" onClick={() => setShowEditModal(false)} >
                    <div
                        onClick={(e) => e.stopPropagation()}
                        style={{
                            background: '#ffffff',
                    ...
                    >
                        <div className="ext-announcements-29">
                            ...
                            <h2 className="ext-announcements-31">Edit Announcement</h2>
                        </div>
                        <form onSubmit={handleEditSubmit} className="ext-announcements-32">
                            {formError && (
                                <div className="ext-announcements-33">
                                    {formError}
                                </div>
                            ...
                            <div className="ext-announcements-36">
                                <button type="button" className="btn-danger ext-announcements-37" onClick={() => setShowEditModal(false)}>
                                    Cancel
                                </button>
                                <button type="submit" className="btn-primary ext-announcements-38">
                                    Save Changes
