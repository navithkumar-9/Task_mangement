...
const Sidebar = () => {
  ...
  if (isAdmin) {
    navItems.push(
      {
        path: '/create-member', label: 'Create Member',
        ...
        <div className="sidebar-brand">
          <div className="sidebar-logo">
            <svg width="22" height="22" viewBox="0 0 24 24" fill="none">
              ...
              <path d="M2 17L12 22L22 17" stroke="#fff" strokeWidth="2" strokeLinecap="round"/>
              <path d="M2 12L12 17L22 12" stroke="#fff" strokeWidth="2" strokeLinecap="round"/>
            </svg>
          </div>
