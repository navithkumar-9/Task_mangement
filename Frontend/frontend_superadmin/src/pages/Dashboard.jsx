    ...
    useEffect(() => {
        const fetchDashboardData = async () => {
            ...
            try {
                ...
                const timesheetsEndpoint = '/timesheets/super-admin/?page_size=50';
        ...
        <div className="page">
            ...
            <div className="page-header" style={{ marginBottom: '24px' }}>
                <div>
                    ...
                    <p className="page-subtitle">
                        Welcome back, <span className="text-accent">{profile?.username || user?.username || 'Super Admin'}</span>
                    </p>
                </div>
            </div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '3fr 2fr', gap: '24px', marginBottom: '32px' }}>
                ...
                <div style={{ background: '#fff', borderRadius: '16px', padding: '24px', border: '1px solid var(--border-color)', boxShadow: 'var(--shadow-sm)' }}>
                    <h2 style={{ fontSize: '1.1rem', fontWeight: 700, margin: '0 0 24px', color: 'var(--text-primary)' }}>Workload Distribution (Global)</h2>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr', gap: '24px' }}>
                ...
                <div style={{ background: '#fff', borderRadius: '16px', padding: '24px', border: '1px solid var(--border-color)', boxShadow: 'var(--shadow-sm)' }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px' }}>
                        <h2 style={{ fontSize: '1.1rem', fontWeight: 700, margin: 0, color: 'var(--text-primary)' }}>Top 5 Critical Tasks (Global)</h2>
                        <Link to="/tasks-progress" style={{ fontSize: '0.85rem', fontWeight: 600, color: 'var(--primary)', textDecoration: 'none' }}>View All</Link>
                    </div>
                ...
                <div style={{ background: '#fff', borderRadius: '16px', padding: '24px', border: '1px solid var(--border-color)', boxShadow: 'var(--shadow-sm)' }}>
                    <h2 style={{ fontSize: '1.1rem', fontWeight: 700, margin: '0 0 24px', color: 'var(--text-primary)' }}>Global Activity Feed</h2>
