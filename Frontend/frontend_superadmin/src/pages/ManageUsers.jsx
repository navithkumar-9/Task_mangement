    ...
    return (
        <div onClick={onClose} className="ext-manage-users-132">
            <div
                ...
                className="ext-manage-users-133"
            >
                {/* Header */}
                <div className="ext-manage-users-134">
                    <button
                        onClick={onClose}
                        className="ext-manage-users-135"
                        onMouseEnter={(e) =>
                    ...
                    <div className="ext-announcements-12">
                        ...
                        <div>
                            <h2 className="ext-announcements-29">
                                User Profile
                            </h2>
                ...
                <div className="ext-manage-users-138">
                    <div className="ext-manage-users-139">
                        {user.profile_picture ? (
                            <img
                                ...
                                alt="Avatar"
                                className="ext-manage-users-140"
                            />
                        ) : (
                            <div
                                style={{
                        ...
                        <span className="ext-manage-users-142">
                            @{user.username}
                        </span>
                    </div>
                    ...
                    <div className="ext-manage-users-143">
                        ...
                        <div className="ext-manage-users-144">
                            <div className="ext-manage-users-145">
                                Account Status
                            </div>
                            <div className="ext-manage-users-146">
                    ...
                    <div className="ext-manage-users-143">
                        <div className="ext-manage-users-144">
                            ...
                            <div
                                className="ext-manage-users-147"
                                title={user.email}
                            >
                                {user.email || '-'}
                            </div>
                ...
                <div className="ext-manage-users-149">
                    <button
                        onClick={onClose}
                        className="ext-manage-users-150"
...
const ManageUsers = () => {
    ...
    const handleEditSubmit = async (e) => {
        ...
        try {
            const payload = {};
            if (editForm.user_name !== editingUser.username)
                payload.user_name = editForm.user_name;
            if (editForm.email !== editingUser.email)
                payload.email = editForm.email;
            const phone =
                editForm.phone_number === ''
                    ? null
                    : Number(editForm.phone_number);
            if (phone !== editingUser.phone_number)
                payload.phone_number = phone;

            if (activeTab === 'team-members') {
                payload.can_crud_tasks = editForm.can_crud_tasks;
                await API.put(
                    `/super-admin/team-members/${editingUser.id}/`,
                    payload,
                );
            } else {
                ...
                >
                    ...
                    >
                        ...
                        <form
                            ...
                            className="ext-announcements-30"
                        >
                            {editError && (
                            ...
                            <div className="ext-manage-users-158">
                                <label className="ext-manage-users-159">
                                    Username
                                </label>
                                <input
                                    type="text"
                            ...
                            <div className="ext-manage-users-161">
                                ...
                                />
                                <span className="ext-manage-users-162">
                            ...
                            {activeTab === 'team-members' && (
                                <div className="ext-manage-users-163">
                                    ...
                                    />
                                    <label
                                        htmlFor="can_crud_tasks"
                                        className="ext-manage-users-165"
                                    >
                                        Can CRUD Tasks
                                    </label>
                                </div>
                    ...
                    >
                        <div className="ext-manage-users-169">
                            ...
                            <p className="ext-manage-users-172">
                                ...
                                <strong>@{deletingUser.username}</strong>? This
